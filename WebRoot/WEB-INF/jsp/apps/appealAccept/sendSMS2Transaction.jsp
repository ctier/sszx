 ...
 <head> 
  ...
  <script> 
      ...
      $(document).ready(function(){
    	  var sysContent = args.$('#field0072').val();
          //手动填写的
          var sdContent= args.$('#field0068').val();
      ...
      function OK(){
    	    var flagOpion = args.$('#field0070').children('option:selected').attr('val4cal');
		    var flagValue = args.$('#field0070').children('option:selected').attr('value');
