...
public class ShGroupRoleManager implements WorkflowCustomRoleManager{
	private static Logger LOGGER = Logger.getLogger(ShGroupRoleManager.class);
...
//			String companyField = AppContext.getSystemProperty("appealAccept.formfield.bssqy");
...
//			String groupId = EnumConverUtil.getGroupId(companyId, Constants.SHGROUP);
			...
			for(int i = 0;i<pIds.size();i++){
				...
				LOGGER.info("人员ID==="+id+"======该人员收到的流程数量====="+count);
				if(i == 0){
					minCount = count;
					minId = id;
				}
