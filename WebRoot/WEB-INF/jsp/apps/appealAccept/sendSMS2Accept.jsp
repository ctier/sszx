 ...
 <head> 
  ...
  <script> 
      ...
      $(document).ready(function(){
    	  var sysContent = args.$('#field0061').val();
          //手动填写的
          var sdContent= args.$('#field0062').val();
      ...
      function OK(){
    	    var flagOpion = args.$('#field0060').children('option:selected').attr('val4cal');
		    var flagValue = args.$('#field0060').children('option:selected').attr('value');
