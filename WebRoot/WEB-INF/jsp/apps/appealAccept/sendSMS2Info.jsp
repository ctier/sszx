 ...
 <head> 
  ...
  <script> 
      ...
      $(document).ready(function(){
    	  var sysContent = args.$('#field0033').val();
          //手动填写的
          var sdContent= args.$('#field0034').val();
      ...
      function OK(){
    	    var flagOpion = args.$('#field0038').children('option:selected').attr('val4cal');
		    var flagValue = args.$('#field0038').children('option:selected').attr('value');
