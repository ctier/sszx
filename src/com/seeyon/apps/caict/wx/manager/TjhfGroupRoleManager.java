...
public class TjhfGroupRoleManager implements WorkflowCustomRoleManager{
	private static Logger LOGGER = Logger.getLogger(TjhfGroupRoleManager.class);
	...
	public List<V3xOrgMember> getMatcherMember(String nodeMemberId, String nodeMemberType, Long accountId, boolean up, String startAccountId, 
		...
		LOGGER.info("进入调解单企业企业回复人员getMatcherMember方法中=========");
		try {
			...
			Map<String,Long> map = appealAcceptDao.getMemberId4CaseSplit(Constants.TJFORMMAIN, formRecordId);
