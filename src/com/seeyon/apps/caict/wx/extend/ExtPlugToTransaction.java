 ...
 * @date   2017-3-22
 */
public class ExtPlugToTransaction extends FormFieldCustomExtendDesignManager{

	@Override
	public String getId() {
		return "extPlugToTransaction";
	}
	...
	public String getJsFileURL() {
		return "/seeyon/appeal/appeal.do?method=transSendSMS2Transaction";
	}
