 ...
 * @date   2017-3-22
 */
public class ExtPlugToCancel extends FormFieldCustomExtendDesignManager{

	@Override
	public String getId() {
		return "extPlugToCancel";
	}
	...
	public String getJsFileURL() {
		return "/seeyon/appeal/appeal.do?method=transSendSMS2Cancel";
	}
